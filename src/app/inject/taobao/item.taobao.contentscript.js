      ...
      function (toolbarHtml) {
        ...
        buttonAddCart.click(function () {
          ...
          if (isValidate) {
            ...
            var productTitle = document.querySelectorAll(
              '[class*="mainTitle"]'
            );
            var promotionPro = $("#J_PromoPriceNum");
            var productPricePro = document.querySelectorAll(
              '[class*="priceWrap"]'
            );
            ...
            if (promotionPro.length > 0) {
              ...
              if (productPricePro.length > 1) {
                const price =
                  productPricePro[0].querySelectorAll('[class*="text"]');
            ...
            if (productTitle.length > 0) {
              ...
              productTitle = document.querySelectorAll(
    ...
    $.get(
      ...
      function (containerPriceHtml) {
        ...
        $("#J_PromoWrap").ready(function () {
          ...
          if (
            $("#J_PromoPrice .tb-rmb-num").text().replace("¥", "").trim() !== ""
          ) {
            pricePro = $("#J_PromoPrice .tb-rmb-num")
              .text()
              .replace("¥", "")
              .trim();
          } else if ($("#J_StrPrice .tb-rmb-num").text() !== "") {
            pricePro = $("#J_StrPrice .tb-rmb-num")
              .text()
              .replace("¥", "")
              .trim();
          } else if ($("#J_priceStd .tb-rmb-num").text() !== "") {
            pricePro = $("#J_priceStd .tb-rmb-num")
              .text()
              .replace("¥", "")
              .trim();
          }
